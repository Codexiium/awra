...
const faqs: FaqEntry[] = [
  {
    ...
    a: "We ship all orders via express air freight. Orders over ₹250/- receive complimentary express shipping. Standard delivery takes 2 to 3 business days globally."
  },
  {
